"""Regression checks for the gossipmill casebook."""
...
from casebook.harness import assert_expected, gossipmill_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(gossipmill_summary(), assert_expected())
