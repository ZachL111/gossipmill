...
`gossipmill` is centered on distributed systems work in Rust. The technical target is: Simulate gossip membership and failure suspicion over lossy links.
...
The score is deterministic. The current threshold is 176. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 2.
